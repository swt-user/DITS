from train.sft_dpo_DI_test import sft_dpo_train_v2_DI
...
if __name__ == "__main__":
    ...
    os.makedirs(config["data_influence_path"], exist_ok=True)

    sft_dpo_train_v2_DI(
        config["origin_sft_yaml_path"],
        config["origin_dpo_yaml_path"],
        config["origin_dpo_yaml_path_lora"],
