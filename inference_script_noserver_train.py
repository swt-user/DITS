...
if __name__ == "__main__":
    ...
    if args.dataset_type == "hotpot_qa":
        ...
        loader = DataloaderForMWHQA(split="train", current_id=15000)
        ...
        print("gsm8k")
        is_math = True
        loader = DataloaderForGSM8K(split="train", current_id=15000)
        ...
        # no_use_prompt_pool = True
        print("math")
        loader = DataloaderForMATH(split="train", current_id=15000)
