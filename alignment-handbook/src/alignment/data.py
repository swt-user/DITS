    ...
    for (ds, frac), ds_config in zip(dataset_mixer.items(), configs):
        ...
        for split in splits:
            try:
                ...
                dataset = load_dataset(ds, ds_config, split=split, keep_in_memory=True)
