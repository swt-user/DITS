...
def main():
    ...
    if not os.path.exists(f"/home/wentaos/Optima/local_influence/case0_{new_args.name_str}_{new_args.eval_num}"):
        os.mkdir(f"/home/wentaos/Optima/local_influence/case0_{new_args.name_str}_{new_args.eval_num}")

    try:
        with open(f"/home/wentaos/Optima/local_influence/case0_{new_args.name_str}_{new_args.eval_num}/{new_args.start_point}.txt", "r") as file:
    ...
    if trainer.accelerator.is_main_process:
        ...
        with open(f"/home/wentaos/Optima/local_influence/case0_{new_args.name_str}_{new_args.eval_num}/{new_args.start_point}.txt", 'a', encoding='utf-8') as file:
            # 确保内容以换行符结束
    ...
    for i in range(new_args.start_point, len(raw_datasets["train"])//5):

        if i in seen_ids:
            continue
        temp = [numbers[k] for k in range(i*5, (i+1)*5)]
