...
def dpo_train_v2_data_influence(
    ...
    for i in range(iteration_times):
        ...
        data_influence_path = f"YOUR_FILE_PATH_HERE/inference_results/${dataset_type}_dpo_server_stepnum5/"
                ...
                for j in range(num_device + 1):
                    ...
                    process = subprocess.Popen(
                        ...
                        CUDA_VISIBLE_DEVICES={j} OUTLINES_CACHE_DIR=./outlines/${dataset_type}/${j} python inference_script_server_train_dynamic.py \
                            ...
                            --end_id ${end_point} \
                            --output_root_path "YOUR_FILE_PATH_HERE/inference_results/${dataset_type}_dpo_server_stepnum5/id" \
