...
from agent.agent_vllmnoserver import Agent, VllmAgent, BaseAgent, VLLMAgentNoServer
from model.llm_vllmnoserver import Llama3
...
def vllm_data_generate_noserver(
    model_first: str,
    model_second: str,
    device_first: str,
    device_second: str,
    ...
    agent_second = VLLMAgentNoServer(
        llm=llm_second,
        system_prompt=llmMessage(role="system", content=prompt),
        name="Bob",
        prompt_template=prompt,
