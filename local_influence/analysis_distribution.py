...
def Analysis_distribution(
    ...
    # df.to_csv(f'/home/wentaos/Optima/local_influence/{dataset_type}_record.txt', sep='\t', index=False)
    import pandas as pd
...
if __name__ == "__main__":
    ...
    Analysis_distribution(
        # origin_dpo_path = "/data/group_data/cx_group/MCTS-agent/results/mwh_qa_sft_dpo_DI/dpo/iteration_0_dpo_format.jsonl",
        ...
        # data_influence_path = "/home/wentaos/Optima/inference_results/cbt_dpo_server_stepnum5_validation",
