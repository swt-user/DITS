...
import os
import sys
sys.path.append('YOUR_HOME_PATH_HERE')
...
def generate_influence_dataset(
    ...
    # file_path = "YOUR_HOME_PATH_HERE/inference_results/hotpot_qa_dpo_server_stepnum10_15000"
    # file_path = "YOUR_FILE_PATH_HERE/inference_results/hotpot_qa_dpo_server_stepnum10_15000_dynamic"
    ...
    tokenizer_path = "YOUR_FILE_PATH_HERE/Huggingface_models/Llama-3.1-8B-Instruct"
    ...
    sorted_df =  mix_df.sort_values(by="mix_value", ascending=False)[:select_num]
    ...
    raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_mix_warmup_{select_num}_{max_count}/iteration_{iteration}"))
    ...
    if other_type:
        ...
        raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_MATES_warmup_{select_num}_{max_count}/iteration_{iteration}"))
        ...
        raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_value_warmup_{select_num}_{max_count}/iteration_{iteration}"))
        ...
        index_random = list(range(len(raw_datasets["train"])))[:select_num]
        raw_datasets["train"] = raw_datasets["train"].select(index_random)
        raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_random_warmup_{select_num}_{max_count}/iteration_{iteration}"))

if __name__ == "__main__":
    dataset = "gsm8k"
    iteration = 0
    # generate_influence_dataset(
    #     origin_dpo_path = f"YOUR_FILE_PATH_HERE/results/{dataset}_sft_dpo_DI/dpo/iteration_{iteration}_dpo_format.jsonl",
    #     dataset_path = f"YOUR_FILE_PATH_HERE/my_datasets/{dataset}_sft_dpo_DI/dpo/iteration_{iteration}",
    #     data_influence_path = f"YOUR_FILE_PATH_HERE/inference_results/{dataset}_dpo_iteration_{iteration}_server_stepnum5",
    #     output_dir="YOUR_FILE_PATH_HERE/my_datasets",
    ...
    # single iteration
    # generate_influence_dataset(
    #     origin_dpo_path = f"YOUR_FILE_PATH_HERE/results/{dataset}_dpo/iteration_{iteration}_dpo_format.jsonl",
    #     dataset_path = f"YOUR_FILE_PATH_HERE/my_datasets/{dataset}_dpo/iteration_{iteration}",
    #     data_influence_path = f"YOUR_FILE_PATH_HERE/inference_results/{dataset}_dpo_server_stepnum5_15000",
    #     output_dir="YOUR_FILE_PATH_HERE/my_datasets",
    #     dataset_type = dataset,
    #     stepnum = 5,
    #     select_num = 2505,
    ...
    # dataset_type = "mwh_qa"
    # name = '6_8'
    # data_influence_path = f"YOUR_FILE_PATH_HERE/inference_results/{dataset_type}_dpo_iteration_{iteration}_{name}_server_stepnum5/"
    # mid_dpo_jsonl_root_path = f"YOUR_FILE_PATH_HERE/results/{dataset_type}_sft_dpo_scale/dpo_{name}/"
    # mid_dpo_dataset_root_path = f"YOUR_FILE_PATH_HERE/my_datasets/{dataset_type}_sft_dpo_scale/dpo_{name}/"
    ...
    generate_influence_dataset(
        origin_dpo_path = f"YOUR_FILE_PATH_HERE/results/{dataset}_sft_dpo_DI/dpo/iteration_{iteration}_dpo_format.jsonl",
        dataset_path = f"YOUR_FILE_PATH_HERE/my_datasets/{dataset}_sft_dpo_DI/dpo/iteration_{iteration}",
        data_influence_path = f"YOUR_FILE_PATH_HERE/inference_results/{dataset}_dpo_sever_stepnum5",
        output_dir="YOUR_FILE_PATH_HERE/temp_datasets",
        dataset_type = dataset,
        stepnum = 5,
        select_num = 8000,
        iteration = iteration,
