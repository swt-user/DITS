...
def generate_influence_dataset(
    ...
    raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_mix_warmup_{select_num}/iteration_{iteration}"))
    ...
    if other_type:
        ...
        raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_MATES_warmup_{select_num}/iteration_{iteration}"))
        ...
        raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_value_warmup_{select_num}/iteration_{iteration}"))
        ...
        raw_datasets.save_to_disk(os.path.join(output_dir, f"{dataset_type}_dpo_random_warmup_{select_num}/iteration_{iteration}"))
