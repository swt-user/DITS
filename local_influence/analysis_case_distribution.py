...
def Analysis_distribution(
    ...
    df.to_csv(f'YOUR_HOME_PATH_HERE/local_influence/{dataset_type}_record_new.txt', sep='\t', index=False)
    import pandas as pd
...
if __name__ == "__main__":
    ...
    Analysis_distribution(
        origin_dpo_path = "YOUR_FILE_PATH_HERE/results/mwh_qa_sft_dpo/dpo/iteration_0_dpo_format.jsonl",
        ...
        data_influence_path = "YOUR_FILE_PATH_HERE/inference_results/mwh_qa_dpo_sever_stepnum5",
