from train.dpo_datainfluence import dpo_train, dpo_train_v2_data_influence
...
if __name__ == "__main__":
    ...
    dpo_train_v2_data_influence(
        ...
        origin_dpo_yaml_path_lora=config["origin_dpo_yaml_path_lora"]
    )
